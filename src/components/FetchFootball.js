...
const FetchFootball=()=>{
    ...
    return(
         <div>
            <button onClick={football} className="form control btn btn-primary">click here to buy</button>
            <br></br>
            <div>
                {data.length>0 &&data.map((E)=>(
                    <ul>
                        <div className='football-details'>
                            <p key={E._id}>FOOTBALL:{E.football}</p>
                            <p key={E._id}>BOOTS:{E.boot}</p>
                            <p key={E._id}>PADS{E.pads}</p>
                        </div>
                        <br></br>
                        <div className="football-form">
                        <form>  
                            <br></br> 
                            <label>Name:</label>
